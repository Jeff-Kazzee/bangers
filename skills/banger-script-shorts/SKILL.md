---
name: banger-script-shorts
description: >
  Write short-form vertical video scripts for YouTube Shorts, TikTok, and Instagram Reels. Use whenever the
  user asks to "write a short", "TikTok script", "Reel script", "make a Short about X", "60-second video",
  "vertical video script", "hook for a short", or wants a sub-3-minute punchy vertical script with captions
  and on-screen text. Part of the BANGERS suite; applies Fireship-style density and the first-3-seconds
...
- `${CLAUDE_PLUGIN_ROOT}/references/platforms/platform-playbook.md` §2–4 (Shorts / TikTok / Reels specs, safe zones, ideal length, SEO, sound rules). Confirm which platform(s) — the specs and audio rules differ.
