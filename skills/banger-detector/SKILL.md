---
name: banger-detector
description: >
  Verify that a draft is authentically the author's work and decide how to disclose AI assistance.
  Use whenever the user asks to "run an AI detector", "check if this passes AI detection", "does
  this sound AI-written", "will this get flagged", "check my AI score", "humanize this", or wants
  to state honestly how AI was used in a piece. Part of the BANGERS suite. Runs detectors as one
  weak diagnostic inside a provenance and voice check, records receipts, and refuses the moves
  that damage true writing to chase a score.
metadata:
  version: "1.1.0"
  suite: "bangers"
---
