---
name: banger-longform-written
description: >
  Write long-form written posts: LinkedIn posts, Substack newsletter issues, and Facebook Group posts.
  Use whenever the user asks to "write a LinkedIn post", "write my newsletter", "substack post", "newsletter
  issue", "facebook group post", "a post for my community", "turn this into a LinkedIn post", or wants
  professional/newsletter/community written content with a hook, body, and CTA. Part of the BANGERS suite;
