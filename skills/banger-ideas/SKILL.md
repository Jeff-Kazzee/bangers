...
name: banger-ideas
description: >
  Generate content ideas, angles, hooks, and a posting plan for a creator's social channels.
  Use this whenever the user asks "what should I post", "give me content ideas", "I need video ideas",
  "help me brainstorm content", "what should I make this week", "content calendar", "I'm out of ideas",
  "ride this trend", "turn this news into content", or wants a batch of angles on a topic or niche.
  Also use proactively at the start of any content session to pick WHAT to make before HOW to make it.
...
- `${CLAUDE_PLUGIN_ROOT}/references/creators/_synthesis.md` — the shared laws (ride existing heat, one thing densely, have a verdict).
...
5. **Assign a home platform + format** based on the idea's shape (a quick trick → Short/Reel/TikTok; a comparison or list → carousel; a reaction/opinion → long-form or X; a step-by-step → long-form + Short cutdowns). See `${CLAUDE_PLUGIN_ROOT}/references/platforms/platform-playbook.md` if unsure.
