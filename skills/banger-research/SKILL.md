---
name: banger-research
description: Research current creators, platforms, formats, hooks, and writing patterns, then convert repeated public evidence into dated BANGERS mechanics without copying creator voice.
metadata:
  version: "0.2.0"
  suite: "bangers"
---
...
- `${CLAUDE_PLUGIN_ROOT}/references/research/creator-research-protocol.md`
- `${CLAUDE_PLUGIN_ROOT}/references/research/source-ledger.md`
- `${CLAUDE_PLUGIN_ROOT}/references/creators/_synthesis.md`
